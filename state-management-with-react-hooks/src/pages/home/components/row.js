...
function Row(props) {
    ...
    return (
        <div data-testid={"list-item-" + props.todo.id} key={props.todo.id} className="row">
            ...
            <div className="col s2">
               ...
               <button data-testid={"delete-button-" + props.todo.id} className="btn-flat waves-effect waves-light" onClick={() => props.onDelete()} ><i className="material-icons">delete</i></button>&nbsp;
            </div>
        </div>
    );
}
